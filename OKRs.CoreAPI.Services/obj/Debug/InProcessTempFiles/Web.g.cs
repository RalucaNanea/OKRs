...
namespace OKRs.CoreAPI.Services {
    ...
    public partial class Web : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(Web).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(Web));
        ...
        private string FindResource() {
            string[] resources = typeof(Web).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Web.g.xaml") || resource.Equals("Web.g.xaml"))) {
                    return resource;
                }
            }
